...
if __name__ == "__main__":
    ...
    dataset_path = "/home/diler/dev/downscaling/dataset/rainnet"      # path to RainNet HDF5 file
    patch_hdf5_root = "/home/diler/dev/downscaling/dataset/rainnet" # root patch to save patches
    ...
    for year_item in range(2017, 2018):
        if os.path.exists(dataset_path + f"/{year_item}_08.hdf5"):
